...
<script>
  ...
  $('#editModal').on('show.bs.modal', function (event) {
    ...
    var phoneId = button.data('phoneid'); // Extract phone ID from data-phoneid attribute
    var modal = $(this);
    modal.find('#editPhoneId').val(phoneId); // Set the hidden input value to the phone ID
  });
  ...
  $('#deleteModal').on('show.bs.modal', function (event) {
    ...
    var phoneId = button.data('phoneid'); // Extract phone ID from data-phoneid attribute
    var modal = $(this);
    modal.find('#confirmDelete').attr('data-phoneid', phoneId); // Set data-phoneid attribute of delete button
  });

// AJAX request to delete phone
  ...
  $.ajax({
    ...
    error: function (xhr, status, error) {
      ...
      Swal.fire({
        icon: 'error',
        title: 'Error',
        text: 'Error deleting phone. Please try again.'
      });
    }
  });
});
